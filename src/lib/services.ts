...
export const services: Service[] = [
  {
    ...
    intro:
      'Een complete renovatie raakt uw hele woning — en uw dagelijks leven. Nederdam neemt het volledige traject op zich: van eerste schets en planning tot de coördinatie van alle vakmensen en de uiteindelijke oplevering. Eén aanspreekpunt, één verantwoordelijke partij.',
    responsibilities: [
  ...
  },
  {
    ...
    intro:
      'Een badkamer verbouwen vraagt om precisie: leidingwerk, tegelwerk, elektra en afwerking moeten naadloos op elkaar aansluiten. Nederdam verzorgt de volledige badkamerrenovatie en stemt alle vakdisciplines op elkaar af, zodat het resultaat klopt tot in het detail.',
    responsibilities: [
  ...
  },
  {
    ...
    intro:
      'Een aanbouw of uitbouw vergroot uw woning en verandert hoe u er woont. Nederdam begeleidt het traject van constructieve voorbereiding en vergunning tot realisatie, met oog voor de aansluiting op de bestaande woning.',
    responsibilities: [
  ...
  },
  {
    ...
    intro:
      'Een opbouw voegt een volwaardige verdieping toe zonder dat u hoeft te verhuizen. Nederdam verzorgt de constructieve afstemming en de volledige realisatie, met bijzondere aandacht voor de overgang naar de bestaande woning.',
    responsibilities: [
  ...
  },
  {
    ...
    intro:
      'Goed stucwerk bepaalt hoe strak een ruimte uiteindelijk oogt. Nederdam verzorgt stucwerk als onderdeel van een groter project of als losse opdracht, met een egaal en duurzaam resultaat als uitgangspunt.',
    responsibilities: [
  ...
  },
  {
    ...
    intro:
      'Maatwerk interieurbouw is een volwaardige discipline binnen Nederdam Bouw. Van maatwerkkasten en wandmeubels tot volledig ingerichte ruimtes: wij ontwerpen en maken interieur dat precies past — in maat, materiaal en afwerking.',
    responsibilities: [
...
export const interieurSubServices: Service[] = [
  {
    ...
    intro:
      'Een maatwerkkast benut de ruimte volledig en past bij het interieur alsof hij er altijd was. Nederdam ontwerpt en maakt kasten op maat — van inbouwkast tot vloer-tot-plafond kastwand.',
    responsibilities: [
  ...
  },
  {
    ...
    intro:
      'Bij interieur op maat kijken we naar de ruimte als geheel: indeling, materialen en detaillering die samenhangen. Nederdam ontwerpt en realiseert het interieur als één samenhangend geheel.',
    responsibilities: [
  ...
  },
  {
    ...
    intro:
      'Een wandmeubel op maat brengt rust en samenhang in een ruimte. Van strak TV-meubel tot volledige wandkast: Nederdam ontwerpt en maakt wandmeubels die precies passen bij de ruimte en het gebruik.',
    responsibilities: [
