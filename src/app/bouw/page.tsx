...
export const metadata: Metadata = {
  ...
  description:
    'Nederdam Bouw: complete renovaties en verbouwingen, badkamerrenovatie, aan- en uitbouw, opbouw en stucwerk in Utrecht. Eén partij die plant, coördineert en oplevert.',
